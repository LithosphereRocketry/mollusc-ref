...
data MSource = MNone | MReg (Unsigned 4)
    deriving (Eq, Show)
data Destination = DReg (Unsigned 4) | DMem
    deriving (Eq, Show)
...
typeDecoder $(bitPattern "...._...._11.._...._...._...._...._....") = InstrTypeLong InstrAuipc
...
decoder instr = DecodeResult {
        ...
        sourceB = case itype of
            ...
            InstrTypeLong InstrAuipc -> Imm $ unpack $ slice d21 d0 instr ++# (0 :: BitVector 10)
